...
multiverse_function_corr <- function(df, decision_space, w1, subset_size) {
  ...
  source(here("scripts/04_set_up_multiverse/08b_conversion_function_corrected.R"))
  ...
  for (sub_start in seq(1, n, by = subset)) {
    ...
    subset_results <- foreach(i = sub_start:sub_end,
                              ...
                              .export = c("w1", "df", "df_type_function", "exclusion_function",
                                          ...
                                          "model_function", "conversion_function_corr", "missingness_function",
                              ...
                              .packages = c("tidyverse", "broom", "broom.mixed", "lme4", "geepack", "survival")) %dopar% {
                                ...
                                tryCatch({
                                  ...
                                  if (universe$model_type == "cox_haz") {
                                    ...
                                    RR <- conversion_function_corr(res, universe$model_type)  
                                  }
    ...
    write_rds(intermediate, here(paste0("data/results/corr_all_models_intermediate_results_Univ100_", sub_start, "_to_", sub_end, "_", Sys.Date(), ".RDS")))
  }
  
  plan(sequential)
  final_results <- bind_rows(all_results)
  write_rds(final_results, here(paste0("data/results/corr_all_models_final_results_Univ100_", sub_end, "_", Sys.Date(), ".RDS")))
}
